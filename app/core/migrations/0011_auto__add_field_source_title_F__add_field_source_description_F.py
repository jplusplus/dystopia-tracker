...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source.title_F'
        db.add_column(u'core_source', 'title_F',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=75, blank=True),
                      keep_default=False)

        # Adding field 'Source.description_F'
        db.add_column(u'core_source', 'description_F',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=300, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source.title_F'
        db.delete_column(u'core_source', 'title_F')

        # Deleting field 'Source.description_F'
        db.delete_column(u'core_source', 'description_F')
