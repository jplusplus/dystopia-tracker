...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Source.title'
        db.delete_column(u'core_source', 'title')

        # Adding field 'Source.title_E'
        db.add_column(u'core_source', 'title_E',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=75, blank=True),
                      keep_default=False)

        # Adding field 'Source.title_D'
        db.add_column(u'core_source', 'title_D',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=75, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Source.title'
        db.add_column(u'core_source', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=75),
                      keep_default=False)

        # Deleting field 'Source.title_E'
        db.delete_column(u'core_source', 'title_E')

        # Deleting field 'Source.title_D'
        db.delete_column(u'core_source', 'title_D')
