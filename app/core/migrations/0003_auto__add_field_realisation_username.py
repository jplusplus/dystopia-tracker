...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Realisation.username'
        db.add_column(u'core_realisation', 'username',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=75),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Realisation.username'
        db.delete_column(u'core_realisation', 'username')
