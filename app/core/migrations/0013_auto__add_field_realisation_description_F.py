...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Realisation.description_F'
        db.add_column(u'core_realisation', 'description_F',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=300, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Realisation.description_F'
        db.delete_column(u'core_realisation', 'description_F')
