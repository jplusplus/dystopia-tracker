...
class PredictionAdmin(ImportExportModelAdmin):
    ...
    search_fields = ('source__title_E', 'source__title_D', 'source__title_F', 'source__author', 'source__year_published', 'year_predicted',
                     'username', 'category__title_E', 'category__title_D', 'category__title_F', 'description_E', 'description_D', 'description_F')
