...
var app = angular.module('dystopia-tracker', [
        ...
        'dystopia-tracker.services']).config([
                ...
                function ($interpolateProvider, $locationProvider, $routeProvider,
                        ...
                        }]).run(['Xiti', '$rootScope', '$translate', function(Xiti, $rootScope, $translate) {
                                $rootScope.xiti = Xiti;
                                $rootScope.$watch(function() { return $translate.use() }, function(lang) {
                                        if(lang) Xiti.setLanguage(lang);
                                })
                        }]);
